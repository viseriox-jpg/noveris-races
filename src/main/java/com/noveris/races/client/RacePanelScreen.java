...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String[] passives(Race r){return switch(r){case ELF->new String[]{"Visão controlável em baixa luz","Velocidade adicional dentro de florestas"};case FAIRY->new String[]{"Regenera perto de flores, fora de combate","Debuffs perdem duração mais rapidamente"};case SATYR->new String[]{"Mais rápido e ágil sobre terreno natural","Metade do dano de queda; cura em florestas"};case THALASSIAN->new String[]{"Respira, nada e minera normalmente na água","Resistência física enquanto estiver submerso"};case HUMAN->new String[]{"Pressa leve permanente","Não possui poderes ou resistências raciais"};case NEPHILIM->new String[]{"50% menos dano de fogo; chamas duram menos","Debuffs perdem duração; força com pouca vida"};case VAMPIRE->new String[]{"Visão controlável e roubo de vida corpo a corpo","Força e velocidade adicionais durante a noite"};case HALF_BLOOD->new String[]{"Uma característica reduzida de cada ascendência","Ativa e mobilidade combinam as duas origens"};case TIEFLING->new String[]{"Imune a fogo e lava; visão controlável","Recebe poder temporário ao tocar fogo"};case LYCANTHROPE->new String[]{"Força, velocidade e regeneração à noite","Detecta criaturas em um raio curto de 6 blocos"};case DRAGONBORN->new String[]{"12% de resistência física e a empurrão","Resiste ao elemento de sua linhagem"};case HARPY->new String[]{"Salto alto, planagem e queda reduzida","Mais móvel em céu aberto e lugares elevados"};default->new String[0];};}
