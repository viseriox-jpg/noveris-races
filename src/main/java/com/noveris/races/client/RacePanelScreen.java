...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String summary(Race r){return switch(r){case ELF->"Explorador arcano e arqueiro.";case FAIRY->"Suporte natural.";case SATYR->"Mobilidade terrestre silvestre.";case THALASSIAN->"Especialista em ambientes aquáticos.";case HUMAN->"Pessoa comum com eficiência básica.";case NEPHILIM->"Resistência sobrenatural.";case VAMPIRE->"Caçador noturno com sustentação.";case TIEFLING->"Resistente a fogo e ambientes hostis.";case LYCANTHROPE->"Predador fortalecido pela noite.";case DRAGONBORN->"Tanque ofensivo elemental.";case HARPY->"Exploradora extremamente ágil.";case GOD->"Entidade administrativa de poder absoluto.";case NPC->"Personagem secundário para dar vida ao servidor.";default->"Nenhuma raça escolhida.";};}
    private String active(Race r){return switch(r){case ELF->"DISPARO PERFURANTE";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"VÉU DE MARÉ";case AIR->"RAJADA FEÉRICA";default->"RAÍZES PRENSORAS";};case SATYR->"VIGOR SILVESTRE";case THALASSIAN->"GUARDA DAS MARÉS";case NEPHILIM->"RAJADA DE LUZ";case VAMPIRE->"DRENAGEM DE SANGUE";case TIEFLING->"PULSO ÍGNEO";case LYCANTHROPE->"UIVO DE CAÇADA";case DRAGONBORN->"SOPRO ELEMENTAL";case HARPY->"RAJADA DE VENTO";case GOD->"JULGAMENTO DIVINO";case NPC->"INVESTIDA DE GUARDA";default->"—";};}
    private String mobility(Race r){return switch(r){case ELF->"RECUO ACROBÁTICO";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"SALTO DE MARÉ";case AIR->"SALTO ATMOSFÉRICO";default->"SALTO DE CIPÓ";};case SATYR->"INVESTIDA CAPRINA";case THALASSIAN->"IMPULSO AQUÁTICO";case NEPHILIM->"IMPULSO RADIANTE";case VAMPIRE->"PASSO SOMBRIO";case TIEFLING->"AVANÇO EM FOGO";case LYCANTHROPE->"BOTE PREDATÓRIO";case DRAGONBORN->"INVESTIDA DRACÔNICA";case HARPY->"IMPULSO DE MOBILIDADE";case GOD->"TELEPORTE CELESTIAL";case NPC->"—";default->"—";};}
    private String activeInfo(Race r){return switch(r){case ELF->"Projétil mágico perfurante: 2,5 corações em linha.";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"Empurra, apaga fogo, cura 1 coração e concede Resistência.";case AIR->"Rajada em linha causa 1,5 coração, empurra e concede Velocidade.";default->"Prende inimigos por 3s, causa 1 coração e purifica um efeito negativo.";};case SATYR->"Concede velocidade e regeneração temporárias.";case THALASSIAN->"Concede resistência por 6s e apaga fogo, em qualquer ambiente.";case NEPHILIM->"Feixe frontal que causa 2 corações e Lentidão por 5 segundos.";case VAMPIRE->"Drenagem rouba até 3 corações; mordida cura 0,5 à noite a cada 10s.";case TIEFLING->"Queima e fere criaturas ao redor.";case LYCANTHROPE->"Revela presas; recebe velocidade extra à noite.";case DRAGONBORN->"Dispara o elemento da linhagem em uma área frontal.";case HARPY->"Empurra criaturas com uma rajada frontal.";case GOD->"Raio direcionado: 7 corações a até 20 blocos.";case NPC->"Investida com empurrão e 1,5 coração de dano.";default->"";};}
    private String mobilityInfo(Race r){return switch(r){case ELF->"Recuo de ~3 blocos; remove Lentidão e protege 0,5s. 3 cargas, recarga 45s.";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"Impulso curto, mais forte dentro ou ao lado da água. 3 cargas, recarga 45s.";case AIR->"Passo rápido no chão, com salto curto. 3 cargas, recarga 45s.";default->"Salto curto que funciona melhor em terreno natural. 3 cargas, recarga 45s.";};case SATYR->"Investida terrestre veloz com salto curto. 3 cargas, recarga 45s.";case THALASSIAN->"Arrancada livre na água; em terra exige chão. 3 cargas, recarga 45s.";case NEPHILIM->"Impulso radiante que exige contato com o chão. 3 cargas, recarga 45s.";case VAMPIRE->"Avanço sombrio terrestre na direção do olhar. 3 cargas, recarga 45s.";case TIEFLING->"Avanço terrestre envolto em fogo. 3 cargas, recarga 45s.";case LYCANTHROPE->"Bote terrestre longo para alcançar uma presa. 3 cargas, recarga 45s.";case DRAGONBORN->"Investida terrestre pesada e horizontal. 3 cargas, recarga 45s.";case HARPY->"Impulso de mobilidade único. 3 cargas, recarga 45s.";case GOD->"Teleporta até 28 blocos, se houver espaço seguro.";case NPC->"";default->"";};}
    private String[] passives(Race r){return switch(r){case ELF->new String[]{"Visão controlável em baixa luz","Velocidade adicional dentro de florestas"};case FAIRY->new String[]{"Natureza: purifica veneno em terreno natural","Água: resistência quando molhado; Ar: mobilidade aprimorada"};case SATYR->new String[]{"Mais rápido e ágil sobre terreno natural","Resistência aprimorada; cura em florestas"};case THALASSIAN->new String[]{"Respira e minera normalmente na água","Nado acelerado e visão aquática"};case HUMAN->new String[]{"Pressa I permanente ao trabalhar","Sem habilidades ativas ou poderes sobrenaturais"};case NEPHILIM->new String[]{"50% menos dano de fogo","Força temporária quando está com pouca vida"};case VAMPIRE->new String[]{"Visão controlável; mordida cura 0,5 à noite a cada 10s","Força e velocidade adicionais durante a noite"};case TIEFLING->new String[]{"Imune a dano de fogo e lava; visão controlável","Ao receber fogo, ganha Força temporária"};case LYCANTHROPE->new String[]{"Força, velocidade e regeneração à noite","Detecta criaturas em um raio curto de 6 blocos"};case DRAGONBORN->new String[]{"12% de resistência física e a empurrão","Resiste ao elemento de sua linhagem"};case HARPY->new String[]{"Mobilidade aprimorada em espaços abertos","Desempenho melhor em áreas abertas"};default->new String[0];};}
