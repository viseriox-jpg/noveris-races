...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private boolean visionActive(Race r){if(minecraft.player==null)return false;boolean dark=minecraft.player.level().isNight()||minecraft.player.level().getMaxLocalRawBrightness(minecraft.player.blockPosition())<7;return dark&&(r!=Race.THALASSIAN||minecraft.player.isInWater());}
