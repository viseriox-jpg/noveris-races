...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String mobility(Race r){return switch(r){case ELF->"RECUO ACROBÁTICO";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"SALTO DE MARÉ";case AIR->"SALTO ATMOSFÉRICO";default->"SALTO DE CIPÓ";};case SATYR->"INVESTIDA CAPRINA";case THALASSIAN->"IMPULSO AQUÁTICO";case NEPHILIM->"IMPULSO RADIANTE";case VAMPIRE->"PASSO SOMBRIO";case TIEFLING->"AVANÇO EM FOGO";case LYCANTHROPE->"BOTE PREDATÓRIO";case DRAGONBORN->"INVESTIDA DRACÔNICA";case HARPY->"IMPULSO ALADO";case GOD->"TELEPORTE CELESTIAL";case NPC->"—";default->"—";};}
    ...
    private String[] conditions(Race r){
        return switch(r){
            ...
            case FAIRY -> switch(ClientRaceState.fairyAffinity){
                ...
                case AIR -> new String[]{"Queda lenta ativa ao cair","Lava bloqueia as habilidades feéricas; sem voo contínuo"};
            ...
            case HARPY -> new String[]{"Velocidade adicional exige céu aberto acima de Y=100","Cavernas e armadura pesada reduzem a mobilidade"};
