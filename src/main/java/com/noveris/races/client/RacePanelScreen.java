...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String activeInfo(Race r){return switch(r){case ELF->"Projétil mágico perfurante: 2,5 corações em linha.";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"Rajada aquática causa 2 corações, empurra, apaga fogo e protege.";case AIR->"Rajada de ar causa 2 corações e empurra entidades à frente.";default->"Rajada natural causa 2 corações e aplica Lentidão em área curta.";};case SATYR->"Concede velocidade e regeneração temporárias.";case THALASSIAN->"Concede resistência temporária e apaga fogo.";case NEPHILIM->"Feixe frontal que causa 2 corações e Lentidão por 5 segundos.";case VAMPIRE->"Fere e rouba até 3 corações durante a noite.";case TIEFLING->"Queima e fere criaturas ao redor.";case LYCANTHROPE->"Revela presas; recebe velocidade extra à noite.";case DRAGONBORN->"Dispara o elemento da linhagem em uma área frontal.";case HARPY->"Empurra criaturas com uma rajada frontal.";default->"";};}
    ...
    private String[] passives(Race r){return switch(r){case ELF->new String[]{"Visão controlável em baixa luz","Velocidade adicional dentro de florestas"};case FAIRY->new String[]{"Natureza: purifica veneno em terreno natural","Água: resistência quando molhado; Ar: queda lenta ao cair"};case SATYR->new String[]{"Mais rápido e ágil sobre terreno natural","Metade do dano de queda; cura em florestas"};case THALASSIAN->new String[]{"Respira e minera normalmente na água","Nado acelerado e visão aquática"};case HUMAN->new String[]{"Pressa I permanente ao trabalhar","Sem poderes sobrenaturais"};case NEPHILIM->new String[]{"50% menos dano de fogo","Força temporária quando está com pouca vida"};case VAMPIRE->new String[]{"Visão controlável e roubo de vida corpo a corpo","Força e velocidade adicionais durante a noite"};case TIEFLING->new String[]{"Imune a fogo e lava; visão controlável","Recebe poder temporário ao tocar fogo"};case LYCANTHROPE->new String[]{"Força, velocidade e regeneração à noite","Detecta criaturas em um raio curto de 6 blocos"};case DRAGONBORN->new String[]{"12% de resistência física e a empurrão","Resiste ao elemento de sua linhagem"};case HARPY->new String[]{"Salto alto e queda reduzida","Mais móvel em céu aberto e lugares elevados"};default->new String[0];};}
