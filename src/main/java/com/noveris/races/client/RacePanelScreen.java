...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String[] weaknesses(Race r){return switch(r){case ELF->new String[]{"Recebe 10% mais dano corpo a corpo","Golpes fortes causam Lentidão breve"};case FAIRY->new String[]{"Armas e ferramentas de ferro causam 30% mais dano","Lava bloqueia habilidades; ferro bloqueia regeneração"};case SATYR->new String[]{"Armadura pesada reduz bônus por etapas","Ambientes subterrâneos reduzem velocidade"};case THALASSIAN->new String[]{"Desidrata ao permanecer longe da água","Fogo causa 60% mais dano"};case HUMAN->new String[]{"Sem resistências naturais especiais","Sem habilidades ativa ou de mobilidade"};case NEPHILIM->new String[]{"Toda cura recebida é 20% menor","Égide termina com Fraqueza I por 3 segundos"};case VAMPIRE->new String[]{"Sol suspende poderes noturnos e roubo de vida","Fogo causa dano extra; comida rende menos"};case HALF_BLOOD->new String[]{"Poderes herdados são versões reduzidas","Também herda parte das fraquezas escolhidas"};case TIEFLING->new String[]{"Regeneração natural é 25% menor","Água aplica Fraqueza temporária"};case LYCANTHROPE->new String[]{"Velocidade e regeneração exigem 6 de fome","Habilidades noturnas aumentam o consumo de fome"};case DRAGONBORN->new String[]{"Movimento 8% menor e fome aumentada","Elemento oposto causa dano adicional"};case HARPY->new String[]{"Recebe 12% mais dano físico","Cavernas e armadura pesada limitam as asas"};default->new String[0];};}
}
