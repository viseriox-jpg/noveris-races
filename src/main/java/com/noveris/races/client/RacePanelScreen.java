...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String activeInfo(Race r){return switch(r){case ELF->"Projétil mágico perfurante: 2,5 corações em linha.";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"Empurra inimigos, apaga fogo, remove 1 efeito e protege.";case AIR->"Rajada frontal que empurra entidades sem causar dano.";default->"Prende inimigos próximos com Lentidão em uma área curta.";};case SATYR->"Concede velocidade e regeneração temporárias.";case THALASSIAN->"Cria uma guarda mais forte quando submerso.";case NEPHILIM->"Feixe frontal que causa 2 corações e Lentidão por 5 segundos.";case VAMPIRE->"Fere e rouba até 3 corações durante a noite.";case TIEFLING->"Queima e fere criaturas ao redor.";case LYCANTHROPE->"Revela presas; recebe mobilidade extra à noite.";case DRAGONBORN->"Dispara o elemento da linhagem em uma área frontal.";case HARPY->"Empurra criaturas com uma rajada frontal.";default->"";};}
