...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String active(Race r){return switch(r){case ELF->"DISPARO PERFURANTE";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"BÊNÇÃO DAS ÁGUAS";case AIR->"RAJADA FEÉRICA";default->"LAÇO DA NATUREZA";};case SATYR->"VIGOR SILVESTRE";case THALASSIAN->"GUARDA DAS MARÉS";case NEPHILIM->"ÉGIDE SOBRENATURAL";case VAMPIRE->"DRENAGEM DE SANGUE";case HALF_BLOOD->"HERANÇA COMBINADA";case TIEFLING->"PULSO INFERNAL";case LYCANTHROPE->"UIVO DE CAÇADA";case DRAGONBORN->"SOPRO ELEMENTAL";case HARPY->"RAJADA DE VENTO";default->"—";};}
    private String mobility(Race r){return switch(r){case ELF->"RECUO ACROBÁTICO";case FAIRY->switch(ClientRaceState.fairyAffinity){case WATER->"CORRENTEZA FEÉRICA";case AIR->"IMPULSO DE BRISA";default->"SALTO ENTRE FOLHAS";};case SATYR->"INVESTIDA CAPRINA";case THALASSIAN->"IMPULSO AQUÁTICO";case NEPHILIM->"IMPULSO RADIANTE";case VAMPIRE->"PASSO SOMBRIO";case HALF_BLOOD->"MOBILIDADE HERDADA";case TIEFLING->"AVANÇO EM FOGO";case LYCANTHROPE->"BOTE PREDATÓRIO";case DRAGONBORN->"INVESTIDA DRACÔNICA";case HARPY->"IMPULSO ALADO";default->"—";};}
