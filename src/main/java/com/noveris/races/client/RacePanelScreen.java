...
public final class RacePanelScreen extends NoverisScreen {
    ...
    private String mobility(Race r){return switch(r){case ELF->"PASSO ENTRE FOLHAS";case FAIRY->"SALTO FLORAL";case SATYR->"INVESTIDA CAPRINA";case THALASSIAN->"IMPULSO AQUÁTICO";case NEPHILIM->"IMPULSO RADIANTE";case VAMPIRE->"PASSO SOMBRIO";case HALF_BLOOD->"MOBILIDADE HERDADA";case TIEFLING->"AVANÇO EM FOGO";case LYCANTHROPE->"BOTE PREDATÓRIO";case DRAGONBORN->"INVESTIDA DRACÔNICA";case HARPY->"IMPULSO ALADO";default->"—";};}
    private String activeInfo(Race r){return switch(r){case ELF->"Projétil mágico perfurante: 2,5 corações em linha.";case FAIRY->"Revela criaturas próximas e concede regeneração.";case SATYR->"Concede velocidade e regeneração temporárias.";case THALASSIAN->"Cria uma guarda mais forte quando submerso.";case NEPHILIM->"Concede resistência e corações de absorção.";case VAMPIRE->"Fere um alvo próximo e recupera vida.";case HALF_BLOOD->"Ativa uma versão reduzida das duas heranças.";case TIEFLING->"Queima e fere criaturas ao redor.";case LYCANTHROPE->"Revela presas; recebe mobilidade extra à noite.";case DRAGONBORN->"Dispara o elemento da linhagem em uma área frontal.";case HARPY->"Empurra criaturas com uma rajada frontal.";default->"";};}
    private String mobilityInfo(Race r){return switch(r){case ELF->"Teleporte seguro: 8 blocos; 12 dentro de florestas.";case FAIRY->"Salto direcionado com proteção na queda seguinte.";case SATYR->"Investida terrestre veloz com salto curto.";case THALASSIAN->"Arrancada forte na água e reduzida em terra.";case NEPHILIM->"Impulso radiante que exige contato com o chão.";case VAMPIRE->"Deslocamento rápido na direção do olhar.";case HALF_BLOOD->"Avanço menor inspirado pelas ascendências.";case TIEFLING->"Avanço envolto em fogo na direção do olhar.";case LYCANTHROPE->"Bote longo para alcançar rapidamente uma presa.";case DRAGONBORN->"Investida pesada, curta e predominantemente horizontal.";case HARPY->"Impulso vertical único; não permite voo contínuo.";default->"";};}
