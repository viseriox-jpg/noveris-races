...
public final class RaceSelectionScreen extends NoverisScreen {
    ...
    private String[] passives(Race r){return switch(r){case ELF->new String[]{"Visão leve em ambientes escuros","Velocidade adicional em florestas"};case FAIRY->new String[]{"Natureza: purifica veneno em terreno natural","Água: resistência breve quando molhado; Ar: queda lenta ao cair"};case SATYR->new String[]{"Rápido no natural; salto alto","Menos queda e regeneração florestal"};case THALASSIAN->new String[]{"Respiração e mineração aquáticas","Nado rápido e visão subaquática"};case HUMAN->new String[]{"Pressa I permanente ao trabalhar","Sem habilidades ativas ou poderes sobrenaturais"};case NEPHILIM->new String[]{"50% menos dano de fogo","Força temporária com pouca vida"};case VAMPIRE->new String[]{"Mordida cura 0,5 à noite a cada 10s","Força e velocidade à noite"};case TIEFLING->new String[]{"Imunidade a fogo e lava","Ao receber fogo, ganha Força temporária"};case LYCANTHROPE->new String[]{"Força, velocidade e regeneração à noite","Faro para criaturas"};case DRAGONBORN->new String[]{"12% de resistência física","Resistência elemental e a empurrão"};case HARPY->new String[]{"Salto alto e queda reduzida","Mobilidade acima de Y=100 com céu aberto"};default->new String[0];};}
