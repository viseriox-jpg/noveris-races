...
public final class RaceSelectionScreen extends NoverisScreen {
    ...
    private String mobility(Race r){return switch(r){case ELF->"Passo Florestal";case FAIRY->"Salto Floral";case SATYR->"Investida Caprina";case THALASSIAN->"Impulso Aquático";case HUMAN->"Arrancada Determinada";case NEPHILIM->"Impulso Radiante";case VAMPIRE->"Passo Sombrio";case HALF_BLOOD->"Mobilidade Herdada reduzida";case TIEFLING->"Avanço em Fogo";case LYCANTHROPE->"Bote Predatório";case DRAGONBORN->"Investida Dracônica";case HARPY->"Impulso Alado";default->"—";};}
    private String[] passives(Race r){return switch(r){case ELF->new String[]{"Visão leve e velocidade em florestas","Arcos carregados causam mais dano"};case FAIRY->new String[]{"Regenera perto da natureza","Poções positivas maiores; resistência mágica"};case SATYR->new String[]{"Rápido no natural; salto alto","Menos queda e regeneração florestal"};case THALASSIAN->new String[]{"Respiração, visão e mineração aquáticas","Nado rápido; resistência submersa"};case HUMAN->new String[]{"Mais experiência e eficiência","Adaptação a equipamentos"};case NEPHILIM->new String[]{"Resistência a fogo e debuffs","Força temporária com pouca vida"};case VAMPIRE->new String[]{"Visão noturna e roubo de vida","Força e velocidade à noite"};case HALF_BLOOD->new String[]{"Uma característica menor de cada origem","Fraquezas parcialmente herdadas"};case TIEFLING->new String[]{"Imunidade a fogo e lava","Visão escura e retaliação"};case LYCANTHROPE->new String[]{"Força e regeneração à noite","Faro para criaturas"};case DRAGONBORN->new String[]{"12% de resistência física","Resistência elemental e a empurrão"};case HARPY->new String[]{"Salto, planagem e queda reduzida","Mobilidade a céu aberto"};default->new String[0];};}
