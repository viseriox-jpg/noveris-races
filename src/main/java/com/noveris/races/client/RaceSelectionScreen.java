...
public final class RaceSelectionScreen extends NoverisScreen {
    ...
    private String mobility(Race r){return switch(r){case ELF->"Recuo Acrobático";case FAIRY->switch(fairyAffinity){case WATER->"Salto de Maré";case AIR->"Passo do Vento";default->"Salto de Cipó";};case SATYR->"Investida Caprina";case THALASSIAN->"Impulso Aquático";case HUMAN->"Nenhuma habilidade de mobilidade";case NEPHILIM->"Impulso Radiante";case VAMPIRE->"Passo Sombrio";case TIEFLING->"Avanço em Fogo";case LYCANTHROPE->"Bote Predatório";case DRAGONBORN->"Investida Dracônica";case HARPY->"Impulso de Mobilidade";default->"—";};}
