...
public final class RaceSelectionScreen extends NoverisScreen {
    ...
    private String description(Race r){return switch(r){case ELF->"Exploração, conhecimento, magia e combate à distância.";case FAIRY->"Magia, suporte e conexão com a natureza.";case SATYR->"Mobilidade terrestre e sobrevivência natural.";case THALASSIAN->"Exploração oceânica e combate aquático.";case HUMAN->"Versatilidade, ferramentas e progressão.";case NEPHILIM->"Resistência sobrenatural equilibrada.";case VAMPIRE->"Sustentação e combate noturno.";case TIEFLING->"Sobrevivência e retaliação.";case LYCANTHROPE->"Predador fortalecido pela noite.";case DRAGONBORN->"Tanque ofensivo de linhagem elemental.";case HARPY->"Exploração e agilidade.";default->"";};}
    private String active(Race r){return switch(r){case ELF->"Disparo Perfurante";case FAIRY->switch(fairyAffinity){case WATER->"Véu de Maré";case AIR->"Rajada Feérica";default->"Raízes Prensoras";};case SATYR->"Vigor Silvestre";case THALASSIAN->"Guarda das Marés";case HUMAN->"Nenhuma habilidade ativa";case NEPHILIM->"Rajada de Luz";case VAMPIRE->"Drenagem de Sangue";case TIEFLING->"Pulso Ígneo";case LYCANTHROPE->"Uivo de Caçada";case DRAGONBORN->"Sopro Elemental";case HARPY->"Rajada de Vento";default->"—";};}
    private String mobility(Race r){return switch(r){case ELF->"Recuo Acrobático";case FAIRY->switch(fairyAffinity){case WATER->"Salto de Maré";case AIR->"Salto Atmosférico";default->"Salto de Cipó";};case SATYR->"Investida Caprina";case THALASSIAN->"Impulso Aquático";case HUMAN->"Nenhuma habilidade de mobilidade";case NEPHILIM->"Impulso Radiante";case VAMPIRE->"Passo Sombrio";case TIEFLING->"Avanço em Fogo";case LYCANTHROPE->"Bote Predatório";case DRAGONBORN->"Investida Dracônica";case HARPY->"Impulso de Mobilidade";default->"—";};}
    private String[] passives(Race r){return switch(r){case ELF->new String[]{"Visão leve em ambientes escuros","Velocidade adicional em florestas"};case FAIRY->new String[]{"Natureza: purifica veneno em terreno natural","Água: resistência breve quando molhado; Ar: mobilidade aprimorada"};case SATYR->new String[]{"Rápido no natural; mobilidade aprimorada","Resistência aprimorada e regeneração florestal"};case THALASSIAN->new String[]{"Respiração e mineração aquáticas","Nado rápido e visão subaquática"};case HUMAN->new String[]{"Pressa I permanente ao trabalhar","Sem habilidades ativas ou poderes sobrenaturais"};case NEPHILIM->new String[]{"50% menos dano de fogo","Força temporária com pouca vida"};case VAMPIRE->new String[]{"Mordida cura 0,5 à noite a cada 10s","Força e velocidade à noite"};case TIEFLING->new String[]{"Imunidade a fogo e lava","Ao receber fogo, ganha Força temporária"};case LYCANTHROPE->new String[]{"Força, velocidade e regeneração à noite","Faro para criaturas"};case DRAGONBORN->new String[]{"12% de resistência física","Resistência elemental e a empurrão"};case HARPY->new String[]{"Mobilidade aprimorada em espaços abertos","Desempenho melhor em áreas abertas"};default->new String[0];};}
    private String[] weaknesses(Race r){return switch(r){case ELF->new String[]{"Golpes corpo a corpo fortes causam Lentidão"};case FAIRY->new String[]{"A regeneração é limitada em condições adversas","Lava bloqueia habilidades"};case SATYR->new String[]{"Armadura pesada reduz mobilidade","Penalidade subterrânea/artificial"};case THALASSIAN->new String[]{"Desidratação longe da água","Fogo aplica Fraqueza temporária"};case HUMAN->new String[]{"Sem resistências sobrenaturais","Sem habilidades ativas ou de mobilidade"};case NEPHILIM->new String[]{"Cura 20% menor","Rajada exige mira e não oferece proteção"};case VAMPIRE->new String[]{"Sol suspende poderes noturnos e roubo de vida","Fogo aplica Fraqueza temporária; comida rende menos"};case TIEFLING->new String[]{"Curas pequenas são 25% menores com fome alta","Água causa Fraqueza"};case LYCANTHROPE->new String[]{"Fome limita bônus e habilidades noturnas","Durante o dia, os bônus noturnos ficam suspensos"};case DRAGONBORN->new String[]{"Movimento lento e fome aumentada","Elemento oposto aplica penalidade temporária"};case HARPY->new String[]{"Golpes físicos causam Lentidão breve","Armadura pesada limita a mobilidade"};default->new String[0];};}
}
