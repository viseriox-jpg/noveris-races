...
public final class RaceSelectionScreen extends NoverisScreen {
    ...
    private String active(Race r){return switch(r){case ELF->"Disparo Perfurante";case FAIRY->switch(fairyAffinity){case WATER->"Véu de Maré";case AIR->"Rajada Feérica";default->"Raízes Prensoras";};case SATYR->"Vigor Silvestre";case THALASSIAN->"Guarda das Marés";case HUMAN->"Nenhuma habilidade ativa";case NEPHILIM->"Égide Sobrenatural";case VAMPIRE->"Drenagem de Sangue";case TIEFLING->"Pulso Infernal";case LYCANTHROPE->"Uivo de Caçada";case DRAGONBORN->"Sopro Elemental";case HARPY->"Rajada de Vento";default->"—";};}
